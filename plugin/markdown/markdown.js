!(function (e, t) {
    ...
    class q {
        ...
        inlineTokens(e, t = []) {
            ...
            for (
                ;
                null != (i = this.tokenizer.rules.inline.escapedEmSt.exec(o));
                    ...
                    switch (u.type) {
                        ...
                        case "table":
                            ...
                            for (
                                ...
                                for (
                                    a = u.rows[r], o = "", l = a.length, s = 0;
                                    s < l;
                                    s++
                                )
                                    o += this.renderer.tablecell(
                                        this.parseInline(a[s].tokens),
                                        { header: !1, align: u.align[s] }
                                    );
    ...
    function N(e, t, n) {
        ...
        if (
            ...
            const i = function (e) {
                ...
                if (!e)
                    try {
                        t.walkTokens && N.walkTokens(s, t.walkTokens),
                            (i = O.parse(s, t));
                    } catch (t) {
                        e = t;
                    }
    ...
    (N.options = N.setOptions =
                ...
                switch ((t.call(N, n), n.type)) {
                    ...
                    default:
                        ...
                        N.defaults.extensions.childTokens[n.type]
                            ? N.defaults.extensions.childTokens[n.type].forEach(
                                  function (e) {
                                      N.walkTokens(n[e], t);
                                  }
                              )
        ...
        (N.parseInline = function (e, t) {
            ...
            try {
                ...
                return (
                    t.walkTokens && N.walkTokens(n, t.walkTokens),
                    O.parseInline(n, t)
                );
            } catch (e) {
                if (
    ...
    return () => {
        ...
        function n(e) {
            ...
            for (let e = 0, r = t.length; e < r; e++) {
                const r = t[e].name,
                    s = t[e].value;
                /data\-(markdown|separator|vertical|notes)/gi.test(r) ||
                    (s ? n.push(r + '="' + s + '"') : n.push(r));
            }
            return n.join(" ");
        }
        function r(t) {
        ...
        function i(e, t) {
            ...
            for (; (l = n.exec(e)); )
                (a = i.test(l[0])),
                    !a && h && p.push([]),
                    (o = e.substring(c, l.index)),
                    a && h ? p.push(o) : p[p.length - 1].push(o),
                    (c = n.lastIndex),
                    (h = a);
        ...
        function a(e, t, n) {
            ...
            if ((i = r.exec(a))) {
                const n = i[1];
                for (
                    a = a.substring(0, i.index) + a.substring(r.lastIndex),
                        e.nodeValue = a;
                    (l = s.exec(n));

                )
                    l[2]
                        ? t.setAttribute(l[1], l[2])
                        : t.setAttribute(l[3], "");
                return !0;
            }
            return !1;
