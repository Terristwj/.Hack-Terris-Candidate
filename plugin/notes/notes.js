!(function (t, e) {
            ...
            if (e) {
                ...
                if (t.header.length === t.align.length) {
                    ...
                    for (a = t.rows.length, n = 0; n < a; n++)
                        t.rows[n] = v(t.rows[n], t.header.length).map((t) => ({
                            text: t,
                        }));
    ...
    class I {
        ...
        inlineTokens(t, e = []) {
            ...
            if (this.tokens.links) {
                ...
                if (t.length > 0)
                    for (
                        ;
                        null !=
                        (r = this.tokenizer.rules.inline.reflinkSearch.exec(o));
            ...
            for (
                ;
                null != (r = this.tokenizer.rules.inline.blockSkip.exec(o));
            ...
            for (
                ;
                null != (r = this.tokenizer.rules.inline.escapedEmSt.exec(o));
                    ...
                    switch (d.type) {
                        ...
                        case "table":
                            ...
                            for (
                                ...
                                for (
                                    l = d.rows[i], o = "", a = l.length, s = 0;
                                    s < a;
                                    s++
                                )
                                    o += this.renderer.tablecell(
                                        this.parseInline(l[s].tokens),
    ...
    function N(t, e, n) {
        ...
        if (
            ...
            const r = function (t) {
                ...
                if (!t)
                    try {
                        e.walkTokens && N.walkTokens(s, e.walkTokens),
                            (r = O.parse(s, e));
                    } catch (e) {
                        t = e;
                    }
    ...
    (N.options = N.setOptions =
                ...
                if (
                    (t.extensions &&
                        ...
                        t.extensions.forEach((t) => {
                            ...
                            t.childTokens &&
                                (n.childTokens[t.name] = t.childTokens);
                        })),
                    t.renderer)
                ) {
        ...
        (N.parseInline = function (t, e) {
            ...
            try {
                ...
                return (
                    e.walkTokens && N.walkTokens(n, e.walkTokens),
                    O.parseInline(n, e)
                );
            } catch (t) {
                if (
